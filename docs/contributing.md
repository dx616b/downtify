...
Use the [GitHub issue tracker](https://github.com/dx616b/downtify/issues). Before opening a new issue, search existing ones to avoid duplicates.
...
```bash
git clone https://github.com/dx616b/downtify.git
cd downtify
